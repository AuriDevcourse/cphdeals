...
export function CategoryFilter({
  ...
  return (
    <div>
      {/* "Type" label — above on mobile, inline on desktop */}
      <span className="mb-1.5 block text-xs font-medium text-zinc-500 sm:hidden">Type</span>
      <div className="flex items-center gap-2">
        <span className="hidden text-xs font-medium text-zinc-500 sm:inline">Type</span>
